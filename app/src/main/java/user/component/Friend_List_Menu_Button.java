...
public class Friend_List_Menu_Button extends javax.swing.JPanel {
    public Friend_List_Menu_Button() {
        initComponents();
        init();
    }
    ...
    private void init() {
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent me) {
                if (mouseOver) {
                    PublicEvent.getInstance().getEventMain().showFriendList();
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        icon.setImage(new javax.swing.ImageIcon(getClass().getResource("/user/friend_list.png"))); // NOI18N

        lb.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        lb.setText("Friend list");
        ...
        layout.setVerticalGroup(
            ...
            .addComponent(icon, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
