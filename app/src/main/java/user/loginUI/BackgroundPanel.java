...
public class BackgroundPanel extends JPanel {
	...
	private void setup() {
		...
		JLabel usernameIcon = new JLabel(new ImageIcon(getClass().getResource("/LoginUI/username.png")));
		usernameIcon.setBounds(590 -150, 225, 50, 50);

		RoundedButton roundedButton = new RoundedButton("Login", radius);
		roundedButton.setBounds(644-150, 368, 335, 50);
		...
		JLabel passwordIcon = new JLabel(new ImageIcon(getClass().getResource("/LoginUI/password2.png")));
		...
		JLabel lblNewLabel_2 = new JLabel(new ImageIcon(getClass().getResource("/LoginUI/img.png")));
